...
And This Github will have 2, like Kpangan-XD and Inpianda-Github !!!

## Main Device
* Handphone      : Redmi 10c Snapdragon 680 4/128GB
* Laptop 1       : Lenovo Ideapad Slim 3 14IRU8 (i3 1315U 8/512GB SSD NVME)
* Laptop 2 (old) : HP 15 Pavilion (idk model) (i5 5200U 4/512GB HDD) 

## if you know, i like :
* i like AMD64 programming, i spent 2-5 Hours of this
* I play Minecraft, Hearts of iron IV (crack), Sand:Box, CS:GO or Valorant::(new)
* i like ARM to, like Custom ROM, UBL (Unlock Bootloader), custom Kernel, and suppose to create OS based ARM to my Phone hahaha (Redmi 10C) 

## Another Error Android QH_SUSB_BULK
![Kpangan-XD](https://github.com/Kpangan-XD/Kpangan-XD/blob/main/pianda2.jpeg)


<!--
**Kpangan-XD/Kpangan-XD** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
